...
Figure 1: architecture of HouseDiffusion model
...
Figure 2: sample floorplans of our own model and of the HouseDiffusion pretrained model
## Discussion
...
| Author             | Contribution                                                                                                                                              |
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Lennart Koetzier   | Reproduction, Adjusting HouseGAN++ repository for preprocessing, Excluding unrealistic floor plans, Debug HouseDiffusion repository for model training, Blog, Data preprocessing, Experiments, Results, Discussion + Conclusion |
| Renee Schwietert   | Reproduction, Debugging HouseGAN++ repository, Excluding unrealistic floor plans, Debug HouseDiffusion repository for model training, Debug HouseDiffusion repository for sampling, Blog, Introduction, Create Github blog, Added code to blog, Finishing touches |

Additional contributions can be found in github commit. During project time we worked together in 1 commit. 
